...
public class LoanController {
    ...
    public ResponseEntity<HttpResponse> returnBook(
        ...
        final User librarian = userService.getUserByEmail(authentication.getName());
        final Loan loan = loanService.returnBook(loanId, librarian);
    ...
    public ResponseEntity<HttpResponse> extendLoan(
        ...
        final User librarian = userService.getUserByEmail(authentication.getName());
        final Loan loan = loanService.extendLoan(loanId, days, librarian);
        return ResponseEntity.status(HttpStatus.OK)
                .body(HttpResponse.builder()
                        .statusCode(HttpStatus.OK.value())
                        .httpStatus(HttpStatus.OK)
    ...
    public ResponseEntity<HttpResponse> markBookAsLost(
        ...
        final User librarian = userService.getUserByEmail(authentication.getName());
        final Loan loan = loanService.markBookAsLost(loanId, notes, librarian);
        return ResponseEntity.status(HttpStatus.OK)
                .body(HttpResponse.builder()
                        .statusCode(HttpStatus.OK.value())
                        .httpStatus(HttpStatus.OK)
