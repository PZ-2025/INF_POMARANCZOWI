    ...
    SecurityFilterChain securityFilterChain(HttpSecurity security) throws Exception {
        ...
        security.authorizeHttpRequests(
                        auth -> auth
                                ...
                                .requestMatchers(PUT, "/api/v1/user/{id}/block").hasAuthority("ADMIN")
                                .requestMatchers(PUT, "/api/v1/user/{id}/unblock").hasAuthority("ADMIN")
                                .requestMatchers(PUT, "/api/v1/user/{id}/verify").hasAuthority("ADMIN")
