...
create table user_settings (dark_mode bit not null, email_notifications_enabled bit not null, email_reminders_enabled bit not null, new_books_notifications_enabled bit not null, notifications_enabled bit not null, id bigint not null AUTO_INCREMENT, primary key (id)) engine=InnoDB;
